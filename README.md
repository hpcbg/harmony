...
- `PICK_OFFSET_MM`: offset of the zero pick position (previously it was in the bottle detector configuration);
- `PICK_RPY_DEG`: offset of the pick orientation (previously it was in the bottle detector configuration);
