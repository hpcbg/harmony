...
/**
 * Displays a bar chart for a history widget
 * Data is retrieved from Redux using the widget ID
 */
export default function HistoryWidgetBarChart({ widget }) {
  // Data comes from centralized widgetDataSlice
