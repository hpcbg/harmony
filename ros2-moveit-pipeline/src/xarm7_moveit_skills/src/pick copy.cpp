...
static const rclcpp::Logger LOGGER = rclcpp::get_logger("pick");
...
void PickNode::setupPlanningScene()
{
  ...
  pose.position.z = 1.09218;
  pose.orientation.x = 0.709652;
  pose.orientation.y = 0.002088;
  pose.orientation.z = -0.000690;
  pose.orientation.w = 0.704548;
  object.pose = pose;
...
mtc::Task PickNode::createTask()
{
  ...
  ---- *               Generate Grasp Pose                *
     ***************************************************/
    {
      ...
      // This is the transform from the bottle frame to the end-effector frame
  ...
  {
    auto place = std::make_unique<mtc::SerialContainer>("place bottle");
  ...
  ---- *               Generate Place Pose                *
    ...
    {
      auto stage = std::make_unique<mtc::stages::ModifyPlanningScene>("detach bottle");
